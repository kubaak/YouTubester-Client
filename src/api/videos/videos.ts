...
export const getGetApiVideosVideoIdQueryOptions = <TData = Awaited<ReturnType<typeof getApiVideosVideoId>>, TError = AxiosError<ProblemDetails | ProblemDetails>>(videoId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiVideosVideoId>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
export type GetApiVideosVideoIdQueryError = AxiosError<ProblemDetails | ProblemDetails>


export function useGetApiVideosVideoId<TData = Awaited<ReturnType<typeof getApiVideosVideoId>>, TError = AxiosError<ProblemDetails | ProblemDetails>>(
...
export const getPostApiVideosUpdateMutationOptions = <TError = AxiosError<ProblemDetails | ProblemDetails>,
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiVideosUpdateMutationError = AxiosError<ProblemDetails | ProblemDetails>

    /**
 * @summary Updates a video's editable metadata (title, description, tags).
 */
export const usePostApiVideosUpdate = <TError = AxiosError<ProblemDetails | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiVideosUpdate>>, TError,{data: UpdateVideoMetadataRequest}, TContext>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient): UseMutationResult<
...
export const getPostApiVideosSaveDraftMutationOptions = <TError = AxiosError<ProblemDetails | ProblemDetails>,
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiVideosSaveDraftMutationError = AxiosError<ProblemDetails | ProblemDetails>

    /**
 * @summary Saves draft video metadata (title, description, tags) without submitting to YouTube.
 */
export const usePostApiVideosSaveDraft = <TError = AxiosError<ProblemDetails | ProblemDetails>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiVideosSaveDraft>>, TError,{data: UpdateVideoMetadataRequest}, TContext>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient): UseMutationResult<
