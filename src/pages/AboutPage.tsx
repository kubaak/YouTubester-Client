  ...
  var features = [
    {
      ...
      description: "Create and manage video templates with AI-powered suggestions to streamline your content creation process."
    },
    {
      icon: <MessageCircle className="w-8 h-8 text-primary" />,
      title: "Intelligent Reply Management",
      description: "Automatically generate contextual replies to comments using advanced AI algorithms tailored to your brand voice."
    },
    {
    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Empowering YouTube creators with AI-driven tools to enhance engagement, 
            streamline content management, and build stronger communities.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              At YouTubester, we believe that every creator deserves powerful tools to grow their audience 
              and manage their channel effectively. Our mission is to democratize access to advanced 
              YouTube management capabilities through intuitive AI-powered solutions.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              We're committed to helping creators save time, increase engagement, and focus on what 
      ...
      <div>
        <h2 className="text-2xl font-bold text-foreground mb-8 text-center">
          What Makes YouTubester Special
        </h2>
      ...
      <div className="glass rounded-2xl p-8 border border-border/50">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4">
          <p className="text-muted-foreground leading-relaxed">
            Our team consists of experienced YouTube creators, developers, and AI specialists 
            who understand the challenges of content creation firsthand. We've been where you are, 
            and we're here to help you succeed.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Every feature in YouTubester is built based on real creator needs and feedback from 
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Join thousands of creators who are already using YouTubester to grow their channels 
          and engage with their communities more effectively.
        </p>
