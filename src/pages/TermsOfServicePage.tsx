  ...
  var sections = [
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            By accessing and using YouTubester, you accept and agree to be bound by the terms and provision of this agreement. 
            If you do not agree to abide by the above, please do not use this service.
          </p>
          <div className="bg-green-50 border border-green-200 rounded-xl p-4">
            <p className="text-sm text-green-800">
              <strong>Key Point:</strong> Your use of our service constitutes acceptance of these terms. 
              If you disagree with any part of these terms, you must discontinue use of YouTubester.
            </p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            YouTubester is a platform that provides AI-powered tools for YouTube creators, including automated comment replies, 
            video template management, and channel analytics. Our service is designed to help creators manage their channels more efficiently.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <p className="text-sm text-blue-800">
              <strong>Service Evolution:</strong> We continuously improve our service and may add, modify, or remove features. 
              We'll notify users of significant changes that affect their experience.
            </p>
          </div>
        </div>
      )
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Maintain the security and confidentiality of your account credentials and notify us immediately of any unauthorized use.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Use our service only for lawful purposes and in accordance with these terms and applicable laws.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Take full responsibility for all content generated through our platform and ensure it complies with YouTube's terms of service.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Provide accurate, current, and complete information when creating your account and using our services.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Creating spam content, harassing other users, or generating inappropriate or offensive replies.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Any illegal activities, including but not limited to copyright infringement, fraud, or violation of privacy rights.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Attempting to access, tamper with, or use non-public areas of the service, computer systems, or technical delivery systems.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Circumventing, disabling, or otherwise interfering with security-related features or usage limits.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-4">
            <p className="text-sm text-red-800">
              <strong>Enforcement:</strong> Violation of these prohibited uses may result in immediate termination of your account 
              and legal action if necessary. We reserve the right to determine what constitutes a violation.
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-4">
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              The YouTubester service and its original content, features, and functionality are and will remain the exclusive property 
              of YouTubester and its licensors. The service is protected by copyright, trademark, and other laws.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              You retain ownership of content you create using our service. However, you grant us a limited license to use, 
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Any feedback, suggestions, or ideas you provide about our service may be used by us without any obligation to you, 
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground text-sm">
              In no event shall YouTubester, its directors, employees, partners, agents, suppliers, or affiliates be liable for any 
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground text-sm">
              Our service integrates with YouTube and other third-party services. We are not responsible for the availability, 
              functionality, or terms of service of these third-party platforms.
            </p>
          </div>
        </div>
      )
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-xl p-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Please read these Terms of Service carefully before using our service. By using YouTubester, 
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="glass rounded-xl p-6 border border-border/50">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            <p>We reserve the right to terminate or suspend your account immediately, without prior notice, for conduct that we believe violates these Terms of Service.</p>
            <p>Upon termination, your right to use the service will cease immediately, but provisions that by their nature should survive termination will survive.</p>
          </div>
        </div>
        ...
        <div className="glass rounded-xl p-6 border border-border/50">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            <p>These Terms of Service are governed by and construed in accordance with the laws of the jurisdiction where YouTubester operates.</p>
            <p>Any disputes arising under these terms will be subject to the exclusive jurisdiction of the courts in that jurisdiction.</p>
          </div>
        </div>
        ...
        <div className="glass rounded-xl p-6 border border-border/50">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            ...
            <p>The invalid or unenforceable provision will be replaced with a valid provision that most closely matches the intent of the original provision.</p>
          </div>
        </div>
      </div>
      ...
      <div className="glass rounded-xl p-8 border border-border/50">
        ...
        <div className="space-y-4 text-muted-foreground">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-6">
            ...
            <p className="text-sm text-blue-800">
              Premium subscriptions are billed monthly or annually in advance. We offer a 30-day money-back guarantee for new subscribers. 
      ...
      <div className="bg-green-50 border border-green-200 rounded-xl p-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-800">
              By using YouTubester, you acknowledge that you have read these Terms of Service, understood them, 
              and agree to be bound by them. These terms constitute the entire agreement between you and YouTubester 
