...
export default function ContactPage() {
  ...
  var handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        <div className="glass rounded-xl p-8 border border-border/50 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Our team reviews your message and determines the best way to help</p>
            </div>
            <div className="space-y-2">
              <div className="text-2xl font-bold text-primary">2</div>
              <h3 className="font-semibold">We Respond</h3>
              <p className="text-sm text-muted-foreground">You'll receive a response within 24 hours (faster for Premium users)</p>
            </div>
            <div className="space-y-2">
    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {supportChannels.map((channel, index) => (
          <div key={index} className="glass rounded-xl p-6 border border-border/50 hover:shadow-moderate transition-all duration-300 hover-lift">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="glass rounded-xl p-6 border border-border/50">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>• Check our <span className="text-primary font-medium">FAQ section</span> for quick answers</li>
            <li>• Browse our <span className="text-primary font-medium">Help Center</span> for detailed guides</li>
            <li>• Try our <span className="text-primary font-medium">troubleshooting tools</span> in Settings</li>
