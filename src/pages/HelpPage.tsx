...
import { BookOpen, Search, Video, MessageCircle, Settings, Zap, ChevronRight, ExternalLink, PlayCircle } from "lucide-react";

export default function HelpPage() {
  var [selectedCategory, setSelectedCategory] = useState("getting-started");
        ...
        sections: [
          {
            ...
            content: "YouTubester is an AI-powered platform designed to help YouTube creators manage their channels more efficiently. It provides tools for automated comment replies, video template management, and channel analytics."
          },
          {
            title: "Setting up your account",
            content: "1. Sign up for a YouTubester account\n2. Connect your YouTube channel using OAuth\n3. Complete your profile setup\n4. Choose your subscription plan"
          },
          {
            title: "Connecting your YouTube channel",
            content: "To connect your YouTube channel:\n• Go to Settings > Account\n• Click 'Connect YouTube Channel'\n• Sign in with your Google account\n• Grant necessary permissions\n• Your channel will be connected automatically"
          }
        ]
      },
      {
        ...
        sections: [
          {
            ...
            content: "The dashboard provides an overview of your channel performance, recent activity, and quick access to key features."
          },
          {
            title: "First Steps",
        ...
        sections: [
          {
            ...
            content: "Video templates are predefined formats that help you maintain consistency across your content. They include elements like intro/outro scripts, description formats, and tag suggestions."
          },
          {
            title: "Creating a new template",
            content: "1. Navigate to Video Templates\n2. Click 'New Template'\n3. Choose a template type (Tutorial, Review, Vlog, etc.)\n4. Customize the template elements\n5. Save and activate your template"
          },
          {
            title: "Template elements",
            content: "• Title format and suggestions\n• Description structure\n• Tag recommendations\n• Thumbnail guidelines\n• Intro/outro scripts\n• Call-to-action prompts"
          }
        ]
      },
      {
        ...
        sections: [
          {
            ...
            content: "Use placeholders like {{video_topic}}, {{date}}, and {{channel_name}} to automatically populate template fields with relevant information."
          },
          {
        ...
        sections: [
          {
            ...
            content: "Set up approval processes to review AI-generated replies before they're posted to maintain quality control."
          },
          {
            title: "Bulk actions",
        ...
        sections: [
          {
            ...
            content: "Update your personal information, contact details, and communication preferences in the Settings > Profile section."
          },
          {
            title: "Notification preferences",
            content: "Customize which notifications you receive and how you want to be contacted (email, in-app, etc.)."
          },
          {
  ...
  var currentContent = helpContent[selectedCategory as keyof typeof helpContent] || [];

  var filteredContent = currentContent.filter(item =>
    searchQuery === "" ||
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Everything you need to know about using YouTubester effectively. 
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        {quickLinks.map((link, index) => (
          <div key={index} className="glass rounded-xl p-4 border border-border/50 hover:shadow-moderate transition-all duration-300 hover-lift cursor-pointer">
