...
export default function PrivacyPolicyPage() {
  ...
  var sections = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>We do not sell, trade, or rent your personal information to third parties. We may share your information in limited circumstances:</p>
          
          <div className="space-y-3">
            <h4 className="font-semibold text-foreground">Service Providers:</h4>
            <p className="text-muted-foreground">We work with trusted third-party service providers who assist us in operating our platform, such as cloud hosting, payment processing, and analytics services. These providers are bound by strict confidentiality agreements.</p>
          </div>

          <div className="space-y-3">
            <h4 className="font-semibold text-foreground">Legal Requirements:</h4>
            <p className="text-muted-foreground">We may disclose your information when required by law, such as to comply with a subpoena, court order, or other legal process, or to protect the rights, property, and safety of YouTubester, our users, and the public.</p>
          </div>

          <div className="space-y-3">
            <h4 className="font-semibold text-foreground">Business Transfers:</h4>
            <p className="text-muted-foreground">In the event of a merger, acquisition, or sale of assets, your information may be transferred as part of the transaction, but only with continued protection under this privacy policy.</p>
          </div>
        </div>
      )
    },
        ...
        <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-4">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm">All data transmission uses TLS encryption, and sensitive data is encrypted at rest using AES-256.</p>
            </div>
            <div className="space-y-2">
              <h4 className="font-semibold text-foreground">Access Control:</h4>
              <p className="text-muted-foreground text-sm">Strict access controls limit who can view your data, with regular access reviews and monitoring.</p>
            </div>
            <div className="space-y-2">
              <h4 className="font-semibold text-foreground">Infrastructure:</h4>
              <p className="text-muted-foreground text-sm">We use secure cloud infrastructure with regular security audits and compliance certifications.</p>
            </div>
            <div className="space-y-2">
              <h4 className="font-semibold text-foreground">Monitoring:</h4>
              <p className="text-muted-foreground text-sm">24/7 security monitoring and incident response to detect and prevent unauthorized access.</p>
            </div>
          </div>

          <div className="bg-primary/10 border border-primary/20 rounded-xl p-4">
            <p className="text-sm text-foreground">
              <strong>Important:</strong> While we implement robust security measures, no system is 100% secure. We cannot guarantee absolute security, but we continuously work to protect your information using industry best practices.
            </p>
          </div>
        </div>
      )
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Request a copy of your personal data in a structured, commonly used format.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Update or correct inaccurate personal information through your account settings.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Request deletion of your personal data, subject to certain legal and operational requirements.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Opt out of marketing emails at any time using the unsubscribe link or account settings.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Request limitations on how we process your personal information in certain circumstances.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Your privacy is important to us. This policy explains how we collect, use, and protect your information when you use YouTubester.
          </p>
      ...
      <div className="glass rounded-xl p-8 border border-border/50">
        ...
        <div className="space-y-4 text-muted-foreground">
          <p>
            At YouTubester, we are committed to protecting your privacy and ensuring transparency about how we handle your personal information. This Privacy Policy describes our practices concerning the collection, use, and disclosure of information when you use our service.
          </p>
          <p>
            By using YouTubester, you agree to the collection and use of information in accordance with this policy. We will not use or share your information except as described in this Privacy Policy.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="glass rounded-xl p-6 border border-border/50">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            ...
            <p>Account data is retained until you delete your account or request deletion. Usage analytics may be retained longer in anonymized form for service improvement.</p>
          </div>
        </div>
        ...
        <div className="glass rounded-xl p-6 border border-border/50">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            <p>Our servers are located in secure data centers. If you access our service from outside these regions, your information may be transferred internationally.</p>
            <p>We ensure adequate protection for international transfers through appropriate safeguards and security measures.</p>
          </div>
        </div>
        ...
        <div className="glass rounded-xl p-6 border border-border/50">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            <p>YouTubester is not intended for users under 13 years old. We do not knowingly collect personal information from children under 13.</p>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground">
              YouTubester is committed to compliance with applicable privacy laws including GDPR, CCPA, and other regional privacy regulations. 
